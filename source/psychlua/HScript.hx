...
class HScript extends SScript
{
    ...
    public var modchartObjects:Map<String, Dynamic> = new Map<String, Dynamic>(); // Added for modchart support
    ...
    public static function initHaxeModule(parent:FunkinLua) {
        if (parent.hscript == null) {
            trace('Initializing HScript for: ${parent.scriptName}');
    ...
    public static function initHaxeModuleCode(parent:FunkinLua, code:String, ?varsToBring:Any = null) {
        ...
        if (hs == null) {
            ...
            if (hs.parsingException != null) {
                PlayState.instance.addTextToDebug('ERROR (${hs.origin}): ${hs.parsingException.message}', FlxColor.RED);
            }
        }
    }
    #end
	...
	override function preset() {
		...
		set("RatingSprite", RatingGroup.RatingSprite);
		...
		// Notes & Strums (Essential for Modcharts)
		set("Note", Note);
		...
		// Proxy Objects (Used for Advanced Modchart Effects)
		set("ProxyField", ProxyField);
		set("ProxySprite", ProxySprite);

		// Modchart System (Must Keep!)
		set("ModManager", ModManager);
		set("Modifier", Modifier);
		set("SubModifier", SubModifier);
		set("NoteModifier", NoteModifier);
		set("EventTimeline", EventTimeline);
		set("StepCallbackEvent", StepCallbackEvent);
		set("CallbackEvent", CallbackEvent);
		set("ModEvent", ModEvent);
		set("EaseEvent", EaseEvent);
		set("SetEvent", SetEvent);

		// Modifier Support
		set("HScriptModifier", HScriptModifier);
		...
		// ✅ **Modchart Functions**
        set('addModchartObject', function(name:String, obj:Dynamic) {
            modchartObjects.set(name, obj);
        });
        
        set('getModchartObject', function(name:String):Dynamic {
            return modchartObjects.exists(name) ? modchartObjects.get(name) : null;
        });

        set('clearModchartObjects', function() {
